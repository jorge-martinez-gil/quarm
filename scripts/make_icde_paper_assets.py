...
def generated_tex() -> Path:
    ...
    supplement = ["% Generated by scripts/make_icde_paper_assets.py; do not edit manually."]
    supplement.extend(
        [
            r"\begin{table*}[t]",
    ...
    for regime in ["nyc_taxi", "uniform", "skewed", "seasonal"]:
        ...
        supplement.append(r"\addlinespace")
    supplement.extend([r"\bottomrule", r"\end{tabular}", r"\end{table*}"])
    ...
    supplement.extend(
        [
            ...
            r"\toprule",
            r"Dataset & model & rows & debt & top account & top prob. (\%) & $\max|I|$ & full-context best \\",
            r"\midrule",
        ]
    )
